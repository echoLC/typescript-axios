...
describe('cancel: CancelToken', () => {
  describe('reason', () => {
    test('should return a Cancel if ancellation has been requested', () => {
      let cancel: Canceler
    ...
    test('should has nro side effect if call cancellation for multi times', () => {
      let cancel: Canceler
